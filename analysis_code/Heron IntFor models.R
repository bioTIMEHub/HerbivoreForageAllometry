...
HSizeSpecies<-glm(formula=IntFor~Size+Species,family=Gamma(link="log"), data=Heron)
summary(HSizeSpecies)

HSizeDiet<-glm(formula=IntFor~Size+Diet,family=Gamma(link="log"), data=Heron)
summary(HSizeDiet)

HSizeFunc<-glm(formula=IntFor~Size+Func,family=Gamma(link="log"), data=Heron)
summary(HSizeFunc)


HSizeSpeciesint<-glm(formula=IntFor~Size*Species,family=Gamma(link="log"), data=Heron)
summary(HSizeSpeciesint)

HSizeDietint<-glm(formula=IntFor~Size*Diet,family=Gamma(link="log"), data=Heron)
summary(HSizeDietint)

HSizeFuncint<-glm(formula=IntFor~Size*Func,family=Gamma(link="log"), data=Heron)
summary(HSizeFuncint)

HSpeciesm<-glm(formula=IntFor~Species,family=Gamma(link="log"), data=Heron)
summary(HSpeciesm)

HFuncm<-glm(formula=IntFor~Func,family=Gamma(link="log"), data=Heron)
summary(HFuncm)

HDietm<-glm(formula=IntFor~Diet, family=Gamma(link="log"),data=Heron)
summary(HDietm)

HSizem<-glm(formula=IntFor~Diet, family=Gamma(link="log"),data=Heron)
summary(HSizem)
#**************************************************************************
